<template>
  <div id="app">
    ...
    <header id="header-wrapper">
      {{header1}}
      <div>
        <div id="bold-header">{{header2}}</div>
      </div>
    </header>
    <div id="header3">Our Artificial Intelligence powered tools use millions of project data
      <div>
        points
    ...
    <div id="box1">
      <div id="box-header">Supervisor</div>
      <div id="box-text">Monitors activity to identify project roadblocks</div>
      <div id="img1">
    ...
    <div id="box2">
      <div id="box-header">Team Builder</div>
      <div id="box-text">
        Scans our talent network to
    ...
    <div id="box3">
      <div id="box-header">Karma</div>
      <div id="box-text">Regularly evaluates our talent to ensure quality</div>
      <div id="img3">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
          <g fill="none">
    ...
    <div id="box4">
      <div id="box-header">Calculator</div>
      <div id="box-text">
...
export default {
  ...
  data() {
    return {
      header1: "Reliable, efficient delivery",
      header2: "Powered by Technology"
    };
  }
};
</script>
...
#box1 {
  ...
  top: 360px;
  left: 245px;
  box-shadow: 0px 10px 25px 0px rgba(54, 61, 120, 0.2);
}
#box2 {
  background-color: white;
  border-top-style: solid;
